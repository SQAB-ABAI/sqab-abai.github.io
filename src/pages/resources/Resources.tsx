          ...
          <MDBCard>
            <MDBCardBody>
              ...
              <MDBCardText style={CardBodyTextStyle}>
                As an aide in disseminating experimental research, the SQAB board has curated
                information and materials from a range of Laboratories and research outlets.
              </MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
              ...
              <ul className="resources-ul">
                {resourcesJson.Labs.map((lab) => {
                  return (
                    <li key={`lab-${lab.Name}`}>
                      <p>
                        {`${lab.Name}; ${lab.University} (${lab.PI})`}
                        {''}
