          ...
          <MDBCard style={{ height: '100%' }}>
            <MDBCardBody>
              ...
              <MDBCardText style={CardBodyTextStyle}>
                SQAB 2022 Membership is $20 and is payable through PayPal or surface mail. The
                membership fee is separate from registration fees.
                <br />
                <br />
          ...
          <MDBCard style={{ height: '100%' }}>
            <MDBCardBody>
              ...
              <MDBCardText style={CardBodyTextStyle}>
                ...
                attend or submit future work to SQAB, and/or removal from the event, pursuant to
                Board consensus in consideration of the violation.
                <br />
                <br />
                Terms of Registration were approved by the SQAB Executive Board in 2018 and were
                based on those developed by ABAI with the approval of ABAI.
              </MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
        ...
        <MDBCol sm="8">
          <MDBCard style={{ height: '100%' }}>
            <MDBCardBody>
              ...
              <MDBCardText style={CardBodyTextStyle}>Registration is closed.</MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
      </MDBRow>
